...
defaults.register_for_default_handlers(temp_humidity_battery, temp_humidity_battery.supported_capabilities)
local driver = ZigbeeDriver("zigbee-temp-humidity-battery", temp_humidity_battery)
driver:run()
